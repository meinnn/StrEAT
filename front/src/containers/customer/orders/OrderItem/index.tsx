...
export default function OrderItem({
  ...
  return (
    <section className="pt-3 pb-2 flex flex-col px-6 shadow-md bg-white rounded-lg overflow-hidden">
      ...
      <div className="flex justify-between w-full items-center pb-4">
        ...
        {progress !== 4 ? (
          <div className="flex flex-col gap-2 items-center">
            ...
            <p className="text-xs font-semibold text-primary-500">주문 확인</p>
          </div>
        ) : null}
      </div>
      {progress === 4 ? (
