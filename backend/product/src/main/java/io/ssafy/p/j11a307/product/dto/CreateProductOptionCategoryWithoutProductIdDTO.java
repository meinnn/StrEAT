...
@Schema(description = "상품 ID 없이 옵션 카테고리를 생성하기 위한 DTO")
public record CreateProductOptionCategoryWithoutProductIdDTO(
    ...
    public CreateProductOptionCategoryDTO withProductId(Integer productId) {
