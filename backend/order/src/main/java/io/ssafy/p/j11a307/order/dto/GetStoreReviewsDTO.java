...
public class GetStoreReviewsDTO {
    ...
    @Builder
    public GetStoreReviewsDTO(String userName, String userPhoto, List<String> orderProducts, Integer score, String content, LocalDateTime createdAt, List<String> srcList) {
